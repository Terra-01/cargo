  ...
  return (
    ...
    >
      <span className="picker-tray__count">
        <span className="picker-tray__count-num" data-testid="picker-count">{pickedIds.size}</span>
        {' '}picked
      </span>
      <div className="picker-tray__chips">
        {isEmpty ? (
          ...
          pickedAnimations.map((a) => (
            ...
            >
              <span className="picker-chip__name">{a.id}</span>
